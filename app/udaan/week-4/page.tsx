            ...
            >
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <p style={{
                  ...
                  Structured Evaluation Readiness
                </p>
                ...
                <p style={{
                  ...
                  Execution must be communicated clearly. Week 4 prepares you for structured evaluation inside the 3 Stage Selection Model. Your narrative is further refined with defined traction signals. This helps in structuring your presentation.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            >
                  ...
                  <div style={{ display: "flex", gap: 12 }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "14px", lineHeight: 1.6, color: "#5a5a72", marginBottom: 0 }}>
                        A structured pitch presentation ready for evaluation.
                      </p>
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 12 }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "14px", lineHeight: 1.6, color: "#5a5a72", marginBottom: 0 }}>
                        Defined traction signals showing early execution results.
                      </p>
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 12 }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "14px", lineHeight: 1.6, color: "#5a5a72", marginBottom: 0 }}>
                        Defined next steps for progression in the ecosystem.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 16 }}>
                  ...
                  onMouseLeave={(e) => {
                    ...
                    <p style={{ fontSize: "13px", color: "#5a5a72", marginBottom: 0, lineHeight: 1.5 }}>
                      Structured format for founder presentations
                    </p>
                  </div>
                  <div style={{
                    background: "#ffffff",
                  ...
                  onMouseLeave={(e) => {
                    ...
                    <p style={{ fontSize: "13px", color: "#5a5a72", marginBottom: 0, lineHeight: 1.5 }}>
                      Track and present your traction data
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  After 4 weeks, you are not exploring tools. You are operating as an Early Stage AI Founder inside an execution-driven ecosystem. From intent to execution in 4 structured weeks.
                </p>
              </div>

              {/* Final Statement - Inside Card */}
              <div style={{
                textAlign: "center",
                paddingTop: 32,
                marginTop: 32,
                ...
                <p style={{
                  ...
                  You have completed the 4-week Udaan program.
                </p>
