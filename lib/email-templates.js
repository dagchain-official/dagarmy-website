...
// Never use localhost URLs in emails; recipients cannot access them
...
export function lieutenantUpgradeEmailTemplate({ userName = 'Soldier' }) {
  ...
  const bodyContent = `
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="margin:10px 0 25px;">
      <tr>
        <td align="center">
          <a href="${BRAND.url}/dashboard" style="background-color:#4158f9; border-radius:8px; color:#fff; font-size:16px; font-weight:600; font-family:'Poppins',sans-serif; text-decoration:none; display:inline-block; padding:14px 40px;">
            View Your Dashboard
          </a>
        </td>
      </tr>
...
export function webinarInvitationEmailTemplate({ userName = 'Member' }) {
  ...
  const bodyContent = `
    ...
    <p style="font-size:14px; line-height:25px; font-weight:400; font-family: 'Poppins', sans-serif; color:#000000; margin:0 0 15px;">
