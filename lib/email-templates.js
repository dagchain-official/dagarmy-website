        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td>
              ...
              <a href="https://daggpt.com" style="display:inline-block; margin:0px 10px 10px;">
                    ...
                    <table align="center" valign="top" border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td style="text-align:center; padding:30px 8% 10px;" class="mbl_pl15 mbl_pr15">
                          <a href="${BRAND.url}">
                            <img src="${IMG}/logo_dagchain.png" alt="DAGChain" style="width:100%; max-width:133px; object-fit: contain; display: inline-block; margin: 0;" />
                          </a>
                        </td>
                      </tr>
                      ${bannerContent}
