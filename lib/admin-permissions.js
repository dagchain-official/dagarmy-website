...
export const ADMIN_ROLE_TEMPLATES = {
  ...
  hr_admin: {
    name: 'HR Admin',
    description: 'Human Resources - manage users, send communications, view logs',
    permissions: [
      'users.read', 'users.write',
      'notifications.read', 'notifications.write',
      'support.read', 'support.write',
  ...
  careers_admin: {
    name: 'Careers Admin',
    description: 'Careers & Recruitment - manage job-related communications and applicants',
    permissions: [
      'users.read',
      'notifications.read', 'notifications.write',
      'marketing.read', 'marketing.write',
  ...
  finance_admin: {
    name: 'Finance Admin',
    description: 'Finance - manage withdrawals, payments and financial reports',
    permissions: [
