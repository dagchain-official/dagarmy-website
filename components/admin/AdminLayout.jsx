...
export default function AdminLayout({ children }) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      badge: sideCounts.ambassador_new > 0 ? String(sideCounts.ambassador_new) : null
    },
    {
      title: "Email",
      icon: (
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f8fafc' }}>
      ...
      >
        ...
        {/* Footer */}
        {!sidebarOpen && (
          <div style={{ padding: '12px', borderTop: '1px solid #e2e8f0', display: 'flex', justifyContent: 'center' }}>
            <button
