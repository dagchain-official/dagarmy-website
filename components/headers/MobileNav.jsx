    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <a href="/rewards-overview" onClick={(e) => { e.preventDefault(); onClose(); window.location.href = '/rewards-overview'; }} style={{ display: 'flex', alignItems: 'center', minHeight: '48px', padding: '14px 24px', color: '#374151', textDecoration: 'none', borderBottom: '1px solid #f3f4f6', background: '#ffffff' }}>Rewards</a>
