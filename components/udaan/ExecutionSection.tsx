    ...
    >
      <div className="wrap" style={{ position: "relative", zIndex: 1 }}>
        ...
        <motion.div {...fadeUp(0.4)}>
          ...
          >
            The 4-Week Execution Framework
          </h3>
          ...
          >
            {[
              {
                week: "Week 1",
                title: "Opportunity Discovery & Problem Clarity",
              },
              {
                week: "Week 2",
                title: "MVP Creation using accessible AI & automation tools",
              },
              {
                week: "Week 3",
                title: "Market Outreach & Early Monetization",
              },
              {
                week: "Week 4",
                title: "Scale Readiness, Team Structuring & Pitch Preparation",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
